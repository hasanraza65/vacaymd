...
<html>
  <head>
    <title>Order Sent To Pharmacy</title>
    <style>
  ...
  <body>
    <div class="card">
      ...
      <div class="card-body">
        <br>
        <center>
        <b><p>Order #{{$data->order_num}} has been sent to pharmacy. <br><a href="https://orders.vacaymd.com/login"> Click here to login. </a></b><br>
        </center>
