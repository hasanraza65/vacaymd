  ...
  <body>
    <div class="card">
      ...
      <div class="card-body">
        <br>
        <center>
        <b><p>Your payment for order # {{$orderData->order_num}} has been declined.</p></b><br>
        <p><a href="/patient/make-payment/{{$orderData->id}}">Click here</a> to update your payment details to process the order.</p>
        </center>
