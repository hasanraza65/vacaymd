                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All Pharmacies</li>
                            </ol>
                            <a href="/admin/pharmacies/create" class="btn btn-primary">Add New</a>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                                ...
                                <table id="html5-extension" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row_{{$datas->id}}">
                                            ...
                                            <td>{{$datas->pharmacy_name}}</td>
                                            <td>{{$datas->userDetail?->name}} ({{$datas->userDetail?->email}})</td>
                                            <td>{{$datas->pharmacy_phone}}</td>
                                            <td>{{$datas->pharmacy_address}}</td>
