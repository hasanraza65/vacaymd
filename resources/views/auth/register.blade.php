                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="mb-">
                            <select id="state" name="state" class="form-select input-custom" required>
                                <option>Are you in Nevada?</option>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input placeholder="Upload FIle" name="file" accept="image/*,.pdf" type="file" class="form-control input-custom" style="padding-left: 10px;">
                        </div>
                    </div>
