...
<div class="step_info">
    <div class="container" style="padding-left: 30px;">Please provide these information</div>
</div>
...
<form action="/basic_info" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="step-form container">
        ...
        <div class="step-buttons mt-4">
            <button type="submit" class="button-custom" id="submitBtn">Submit and Pay</button>
        </div>
