...
@section('content')
<?php
$dashboard=App\Http\Controllers\Doctor\OrderController::dashboard();
?>
                                    ...
                                    <div class="account-box">
                                        ...
                                        <div class="info-box">
                                            ...
                                            <div class="balance-info">
                                                ...
                                                <p>{{$dashboard['pending_orders']}}</p>
                                            </div>
                                        </div>

                                        <div class="card-bottom-section">
                                            <a href="/doctor/orders" class="">All Orders</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget widget-card-five">
                                <div class="widget-content">
                                    <div class="account-box">
                                        ...
                                        <div class="card-bottom-section">
                                            <a href="/doctor/orders" class="">All Patients Orders</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
